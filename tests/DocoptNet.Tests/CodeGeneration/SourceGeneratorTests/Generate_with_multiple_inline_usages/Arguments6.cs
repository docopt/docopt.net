...
partial class Arguments6 : IEnumerable<KeyValuePair<string, object?>>
{
    ...
    static readonly IBaselineParser<Arguments6> Parser = GeneratedSourceModule.CreateParser(Help, Parse);

    public static IBaselineParser<Arguments6> CreateParser() => Parser;

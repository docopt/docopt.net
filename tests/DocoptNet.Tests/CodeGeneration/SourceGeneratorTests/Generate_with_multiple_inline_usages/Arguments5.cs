...
partial class Arguments5 : IEnumerable<KeyValuePair<string, object?>>
{
    ...
    static readonly IBaselineParser<Arguments5> Parser = GeneratedSourceModule.CreateParser(Help, Parse);

    public static IBaselineParser<Arguments5> CreateParser() => Parser;

...
partial class Arguments7 : IEnumerable<KeyValuePair<string, object?>>
{
    ...
    static readonly IHelpFeaturingParser<Arguments7> Parser = GeneratedSourceModule.CreateParser(Help, Parse);

    public static IHelpFeaturingParser<Arguments7> CreateParser() => Parser;
